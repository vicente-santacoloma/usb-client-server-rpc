...
/**
 * Carga en un vector todos los pedidos que me envia el cliente como
 * cadena de caracteres.
 * @param pedidosString la cadena de caracteres que contiene todos los 
 * pedidos.
 * @return el vector que contiene todos los pedidos.
 */
Vector * generarPedido(char * pedidosString);
